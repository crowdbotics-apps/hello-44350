"""
Django settings for hello_44350 project.
...
WSGI_APPLICATION = 'hello_44350.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hello_44350 API",
    "DESCRIPTION": "API documentation for hello_44350 App",
    "VERSION": "v1",
}
